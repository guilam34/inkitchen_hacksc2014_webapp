...
function retrieveList(arr){
		...
		for(var i =0; i < arr.length; i++){		
			document.getElementById("recipeList").innerHTML +=
				"<p class='entry'><img src =" + arr[i][2] + "><a href='#' class='dishName' id='"+i+"' onclick='overlay(this.id)'>" 
