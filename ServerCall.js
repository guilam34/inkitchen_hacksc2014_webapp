...
function getUrl(igList){
	...
	rawFile.open("GET","http://www.filehosting.org/file/details/462700/IngredientsTestDatabase.txt",false);
	rawFile.onreadystatechange=function(){
		if(rawFile.readyState===4)
		{
			if(rawFile.status===200||rawFile.status===0)
			{
				var allTest=rawFile.responseText;
				alert(allText);
			}
	...
	fReader.onload=function(){
		text=fReader.result.split('\n');
		console.log("text");
	}
	
	fReader.readAsText("http://www.filehosting.org/file/details/462700/IngredientsTestDatabase.txt");
	*/
